...
groups_list = [
    Group("1", label=" ", matches=[], layout="max"),
    Group("2", label=" ", matches=[]),
    Group("3", label=" ", matches=[]),
    Group("4", label="4 ", matches=[]),
    Group("5", label="5 ", matches=[]),
    Group("6", label="6 ", matches=[]),
    Group("a", label=" ", matches=[Match(wm_class="discord")]),
    Group("s", label=" ", matches=[]),
    Group("d", label=" ", matches=[]),
    Group("u", label=" ", matches=[]),
    Group("i", label="i ", matches=[]),
    Group("o", label="o ", matches=[]),
    Group("z", label=" ", matches=[]),
    Group("x", label=" ", matches=[]),
    Group("c", label=" ", matches=[]),
    Group("7", label="7 ", matches=[]),
    Group("8", label="8 ", matches=[]),
    Group("9", label="9 ", matches=[]),
    Group("0", label="0 ", matches=[]),
]
